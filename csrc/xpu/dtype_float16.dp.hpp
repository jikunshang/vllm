...
inline sycl::half add(sycl::half a, sycl::half b) {
  auto val = sycl::ext::intel::math::hadd((a), (b));
  return (val);
}

inline sycl::half2 add(sycl::half2 a, sycl::half2 b) {
  auto val = sycl::ext::intel::math::hadd2((a), (b));
  return (val);
}
...
inline sycl::half mul(sycl::half a, sycl::half b) {
  auto val = sycl::ext::intel::math::hmul((a), (b));
  return (val);
}

template <>
inline sycl::half2 mul(sycl::half2 a, sycl::half2 b) {
  auto val = sycl::ext::intel::math::hmul2((a), (b));
  return (val);
}
...
inline sycl::half2 fma(sycl::half2 a, sycl::half2 b, sycl::half2 c) {
  auto val = sycl::ext::intel::math::hfma2((a), (b), (c));
  return (val);
}
